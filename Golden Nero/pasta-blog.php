...
<html>
    ...
    <body>
        <div id="fullpage">
            <div class="section headline" style="background-image: url(images/posts/pasta-img.JPG)">
            ...
            <div class="section post-content">
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <img src="images/posts/pasta.png" style="width: 100%;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
