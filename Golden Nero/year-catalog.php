...
<html>
    ...
    <body>
        <div id="fullpage">
            <div class="section headline" style="background-image: url(images/posts/year-catalog-img.JPG)">
            ...
            <div class="section post-content">
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <img src="images/posts/year-catalog.png">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
